...
$html.= '</ul>';
  ...
  $html.= '$(document).ready(function(){';
    $html.= '$("#subcategory_val").change(function(){';
      ...
      //$html.= 'alert(val_cat);';
      $html.= '$.ajax({';
        $html.= 'url: "/modules/mymodule/ajaxPage.php?callFor=category&category_id="+val_cat+"&langid="+'.$langid.',';
        ...
        //REMOVE DUPLICATE VALUES
          ...
          // Get the text of the current option
            ...
            $html.= '$("#manufacturer_val").change(function(){';
              ...
              //$html.= 'alert(val_cat);';$html.= '$.ajax({';
              
              $html.= 'url: "/modules/mymodule/ajaxPage.php?callFor=getmanufacturerproducts&manufact_id="+val_manu+"&langid="+'.$langid.',';
              $html.= 'success: function(data){	';
              $html.= '$("#catprodlist").html(data);';
              $html.= '}';
              $html.= '});';
  ...
  $manuresult = ManufacturerCore::getProducts($manuid, $langid, $p = 1, $n = 12, $order_by = 'id_product', $order_way = 'DESC',$get_total = false, $active = true);
